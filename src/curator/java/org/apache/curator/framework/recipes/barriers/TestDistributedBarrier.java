...
public class TestDistributedBarrier extends BaseClassForTests {
	...
	public void testServerCrash() throws Exception {
		...
		final CuratorFramework client = CuratorFrameworkFactory.builder()
				...
				.connectionTimeoutMs(TIMEOUT).retryPolicy(new RetryOneTime(1))
				.build();
		try {
			client.start();
	...
	public void testMultiClient() throws Exception {
		...
		try {
			...
			for (final CuratorFramework c : new CuratorFramework[] { client1,
					client2 }) {
				Future<Object> future = service.submit(new Callable<Object>() {
					@Override
					public Object call() throws Exception {
						c.start();
						DistributedBarrier barrier = new DistributedBarrier(c,
								"/barrier");
